...
# Cria um usuário de sistema dedicado ('-D' cria sem senha) para a aplicação.
...
# Configura o Kestrel (servidor do .NET) para ouvir na porta exposta em todas as interfaces de rede.
